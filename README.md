...
QA Analyst Take-Home Assessment. This repository contains manual test cases, bug reports, and notes for testing the Linq app user flow. It also includes API inspection using Postman and a comprehensive documentation of test scenarios and findings.
=======
